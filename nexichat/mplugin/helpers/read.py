...
╔═══⋆ʟᴏᴠᴇ ᴡɪᴛʜ⋆═══╗
★ [‼ ️Ꭾʀɪ֟፝ؖ۬ɴᴄᴇ 𝐂ᴏᴅᴇz ⚝](https://t.me/SWEETY_BOT_UPDATE)     ★
╚═════ ⋆★⋆ ═════╝
**"""

HELP_READ = f"""**
Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/ll_BOTCHAMBER_ll).
